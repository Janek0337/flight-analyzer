...
START_DATE = os.getenv("GDELT_START_DATE", "20260121")
END_DATE = os.getenv("GDELT_END_DATE", "20260209")
...
gdelt_country_daily.write.mode("append").parquet(OUTPUT_GDELT_COUNTRY_PATH)
