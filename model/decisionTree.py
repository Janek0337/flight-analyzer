...
DEFAULT_OUTPUT = HDFS_BASE + "/bigdata/flight_delay/models/local_weather_delay_decision_tree"
TARGET_COL = "delay_per_flight"
DATE_COL = "date"


def parse_args():
    parser = argparse.ArgumentParser(description="Train delay decision tree model")
...
def main():
    ...
    spark = SparkSession.builder.appName("Flight Delay Decision Tree Model").getOrCreate()
    spark.sparkContext.setLogLevel("WARN")

    print("START: Trening modelu drzewa decyzyjnego opoznien")
    ...
    print("END: Trening modelu drzewa decyzyjnego opoznien")
