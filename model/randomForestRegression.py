...
DEFAULT_OUTPUT = HDFS_BASE + "/bigdata/flight_delay/models/local_weather_delay_random_forest"
TARGET_COL = "delay_per_flight"
DATE_COL = "date"


def parse_args():
    parser = argparse.ArgumentParser(description="Train delay random forest regression model")
...
def main():
    ...
    spark = SparkSession.builder.appName("Flight Delay Random Forest Regression Model").getOrCreate()
    spark.sparkContext.setLogLevel("WARN")

    print("START: Trening modelu random forest regression opoznien")
    ...
    print("END: Trening modelu random forest regression opoznien")
