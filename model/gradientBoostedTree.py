...
DEFAULT_OUTPUT = HDFS_BASE + "/bigdata/flight_delay/models/local_weather_delay_gradient_boosted_tree"
TARGET_COL = "delay_per_flight"
DATE_COL = "date"


def parse_args():
    parser = argparse.ArgumentParser(description="Train delay gradient boosted tree regression model")
...
def main():
    ...
    spark = SparkSession.builder.appName("Flight Delay Gradient Boosted Tree Regression Model").getOrCreate()
    spark.sparkContext.setLogLevel("WARN")

    print("START: Trening modelu gradient boosted tree regression opoznien")
    ...
    rmse, r2, mae = evaluate(predictions, args.label)
    ...
    print("END: Trening modelu gradient boosted tree regression opoznien")
